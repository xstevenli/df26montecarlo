...
cep_50 = pickle.load(open("df_26_moderate_dispersal.p", "rb"))
cep_100 = pickle.load(open("df_26_moderate_dispersal_cep_100.p", "rb"))
cep_300 = pickle.load(open("df_26_moderate_dispersal_cep_300.p", "rb"))
