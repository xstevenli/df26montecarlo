...
#
# MISSILES SENT: 20 each, TO 24 PARKING SPOTS at Andersen AFB, Tinian Int'l, Guam Int'l,
# Rota Int'l and Saipan Int'l
#
...
parking_spots = os.path.expanduser(
    '/Users/stevenli/Desktop/Winter 2021/GOVT 85.12/Paper/gov90-monte-carlo-master/data/24_spots.csv')
...
pickle.dump(df_26_leaker_iterations, open("df_26_moderate_dispersal_cep_300.p", "wb"))