...
#
# CIRCULAR ERROR PROBABLE (CEP): 300 M
#
...
#
# MISSILES SENT: 5 each, TO 6 PARKING SPOTS at Andersen AFB, Tinian Int'l, Guam Int'l,
# Rota Int'l, Saipan Int'l, RAAF Darwin, RAAF Tindal, North FIeld Guam, North Field Tinian,
# Minami Torishima, Yap Int'l, Kosrae Int'l, Pophpei Int'l, Chuuk Int'l, Wake Island,
# Palau Int'l, Angaur, Garden Point, Snake Bay and Bathurst Island.
#
...
parking_spots = os.path.expanduser(
    '/Users/stevenli/Desktop/Winter 2021/GOVT 85.12/Paper/gov90-monte-carlo-master/data/6_spots.csv')
...
for df_26_leaker_n in range(0, df_26_sent+1):
    ...
    # RUN SIMULATION OF DF-26 ALCMS TARGETING AIRCRAFT
    ...
    for monte_carlo_iteration in range(0, monte_carlo_iterations):
        ...
        # CALCULATIONS FOR TARGETS HIT BY DF-26
...
pickle.dump(df_26_leaker_iterations, open("df_26_max_dispersal_cep_300.p", "wb"))